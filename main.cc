...
std::map<std::string, File> files = {
  {"ModelA",  { "/afs/cern.ch/user/y/yoshin/eos/cms/store/group/phys_exotica/EmergingJets/SelectedJetAnalysis-v1/ModelA/EmergingJets_ModelA_TuneCUETP8M1_13TeV_pythia8Mod/SelectedJetAnalysis/160218_043951/output_merged_ModelA.root", 0.0146, 1.0, 0.0, true } },
  {"ModelB",  { "/afs/cern.ch/user/y/yoshin/eos/cms/store/group/phys_exotica/EmergingJets/SelectedJetAnalysis-v1/ModelB/EmergingJets_ModelB_TuneCUETP8M1_13TeV_pythia8Mod/SelectedJetAnalysis/160218_044013/output_merged_ModelB.root", 0.0146, 1.0, 0.0, true } },
  { "QCD_HT700to1000"  ,  { "/afs/cern.ch/user/y/yoshin/eos/cms/store/group/phys_exotica/EmergingJets/SelectedJetAnalysis-v1/QCD_HT700to1000/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/SelectedJetAnalysis/160218_044033/output_merged_QCD_HT700to1000.root"    , 6524     , 4.155094e-03 , 2.008417e-05, false }  },
  { "QCD_HT1000to1500" ,  { "/afs/cern.ch/user/y/yoshin/eos/cms/store/group/phys_exotica/EmergingJets/SelectedJetAnalysis-v1/QCD_HT1000to1500/QCD_HT1000to1500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/SelectedJetAnalysis/160218_044053/output_merged_QCD_HT1000to1500.root" , 1064     , 1.706836e-01 , 4.733912e-04, false }  },
  { "QCD_HT1500to2000" ,  { "/afs/cern.ch/user/y/yoshin/eos/cms/store/group/phys_exotica/EmergingJets/SelectedJetAnalysis-v1/QCD_HT1500to2000/QCD_HT1500to2000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/SelectedJetAnalysis/160218_044114/output_merged_QCD_HT1500to2000.root" , 121.5    , 4.209039e-01 , 7.314915e-04, false }  },
  { "QCD_HT2000toInf"  ,  { "/afs/cern.ch/user/y/yoshin/eos/cms/store/group/phys_exotica/EmergingJets/SelectedJetAnalysis-v1/QCD_HT2000toInf/QCD_HT2000toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/SelectedJetAnalysis/160218_044134/output_merged_QCD_HT2000toInf.root"    , 25.45    , 4.695370e-01 , 8.632537e-04, false }  },
...
int main(int argc, char *argv[])
{
  ...
  for (auto kv: files) {
    auto label = kv.first;
    auto file = kv.second;
    t.InitFromFileName(file.name, file.xsec, file.efficiency, file.isSignal);
